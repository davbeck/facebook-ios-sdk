...
- (FBRequest*)openUrl:(NSString *)url
    ...
    [mutableParams setValue:kSDK forKey:@"sdk"];
    [mutableParams setValue:kSDKVersion forKey:@"sdk_version"];
    ...
    FBRequest* _request = [FBRequest getRequestWithParams:mutableParams
    ...
    if ([action isEqualToString:kLogin]) {
        ...
        if ([action isEqualToString:kApprequests]) {        
            ...
            if (fbid != nil) {
                ...
                id fbids = [NSJSONSerialization JSONObjectWithData:[fbid dataUsingEncoding:NSUTF8StringEncoding] options:0 error:NULL];
